...
public class HTMLUtility {
	...
	// database me key show karega and 
	...
	public static String getList2(String name, String selectedVal, Map<Integer, String> map) {
		...
		//	System.out.println(selectedVal + "hhhhhhhhhhhhhhhiiiiiiiiiiiiiiiiiiiiii--====");
			...
			StringBuffer sb = new StringBuffer(
					"<select style='width: 216px;  height: 23px;' class='form-control' name='" + name + "'>");
	...
	public static String getList3(String name, String selectedValue, Map<Integer, String> map) {
	    if (map == null) {
	        return ""; // Or return a default dropdown HTML string
	    }

	    StringBuilder list = new StringBuilder();
	    list.append("<select name='").append(name).append("'>");
	    for (Map.Entry<Integer, String> entry : map.entrySet()) {
	        String selected = entry.getKey().toString().equals(selectedValue) ? "selected" : "";
	        list.append("<option value='").append(entry.getKey()).append("' ").append(selected).append(">")
    ...
    public static String getList4(String name, String selectedVal, Map<Integer, String> map) {
    ...
    public static String getList5(String name, String selectedVal, Map<String, String> map) {
